...
populateAuditImport.prototype = {
	...
	runAllLogic: function(generateHistorySets){
		...
		this.runTableLogic('u_bai_variations');
	...
	runTableLogic: function(table,generateHistorySets){
		...
		gs.info(table + ' history populated in to u_audit_import');
	},
	...
	createHTMLAuditLine: function(field_label, new_display_value, old_display_value){
		...
		var html = '<li ng-repeat="change in entry.entries.changes" class="ng-scope"><span class="sn-widget-list-table-cell" sn-bind-once="change.field_label">' + field_label + '</span><span class="sn-widget-list-table-cell"><span ng-if="change.new_value" sn-bind-once="change.new_value" class="ng-scope">' + new_display_value + '</span>';
		
		if(old_display_value){
			html += '<span ng-if="change.old_value" class="sn-widget-list-table-italic ng-scope">was</span><span ng-if="change.old_value" sn-bind-once="change.old_value" class="ng-scope">'+old_display_value+'</span>';
		}
